...
(TxtType.prototype.tick = function () {
    ...
    (window.onload = function () {
        for (
            var t = document.getElementsByClassName("typewriter"), e = 0;
            e < t.length;
            e++
        ) {
        ...
        (n.type = "text/css"),
            (n.innerHTML =
                ".typewriter > .wrap { border-right: 0.1em solid #1688f0}"),
        ...
        i("html").removeClass("no-js"),
            i("header a").click(function (t) {
                ...
                i(this).hasClass("no-scroll") ||
                    ...
                    i("html, body").animate(
                        { scrollTop: e + "px" },
                        +Math.abs(window.pageYOffset - i(t).offset().top)
                    ),
                    i("header").hasClass("active") &&
            ...
            i("#experience-timeline").each(function () {
                ($this = i(this)),
                    ...
                    $this.children('span[id="more2"]').each(function () {
                        // Inside this function, `this` refers to each `span` element found
                        $(this).children("div").each(function () {
                            // Inside this nested function, `this` refers to each `div` element
                            $(this)
                                .addClass("vtimeline-content")
